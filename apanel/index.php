        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h2>Hola <b><?php echo htmlspecialchars($_SESSION["username"]); ?></b>, seleccione un usuario.</h2>
                </div>
                ...
                <table class="table">
                    ...
                    <?php while ($usuarios = mysqli_fetch_assoc($datos)) : ?>
                        <tbody>
                            <tr>
                                <th scope="row"><?php echo $usuarios["user_id"] ?></th>
                                <td><?php echo $usuarios["nickname"] ?></td>
                                <td><a class="btn btn-primary" href="/apanel/dashboard.php?id=<?php echo $usuarios["user_id"] ?>">Ver Estadisticas</a> </td>
